...
- Make sure the HTML, the links, and the data are all correct.
...
- If this is the case fix the conflict.
...
If you are ever in doubt, you can always mention me or the other maintainers in the PR itself or DM me on [Twitter](https://twitter.com/Juadeb1)

## Join us

Join us to help grow this project together. Get in touch with me on [Twitter](https://twitter.com/Juadeb1) and send me your GitHub user name so I can add you.
