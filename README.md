# [Contribute To This Project](https://github.com/Juadebfm/Vanilla-JS-Projects.git)

![image info](/assets/favicon.png)
...
| <ul><li>You will see a list of your projects and forks on GitHub.</li><li>Select `<your-github-username>/Contribute-To-This-Project`.</li><li>Click _Clone_</li></ul> | ![Clone project](/assets/clone2.PNG "click on <your-github-username>/Vanilla-JS-Projects") |
| :-------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :----------------------------------------------------------------------------------------: |
...
<h5 align="center">Step 5: Commit your changes</h5>
